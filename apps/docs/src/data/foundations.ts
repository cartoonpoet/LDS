...
export const FOUNDATIONS: FoundationEntry[] = [
  {
    ...
    showcaseHtml: `<div class="type-scale"><div class="row"><span class="nm">Display</span><span class="sample" style="font-size:40px">계약 현황</span><span class="mt">40 / 800</span></div><div class="row"><span class="nm">Heading</span><span class="sample" style="font-size:28px">계약 현황</span><span class="mt">28 / 800</span></div><div class="row"><span class="nm">Title</span><span class="sample" style="font-size:20px">계약 현황</span><span class="mt">20 / 700</span></div><div class="row"><span class="nm">Body</span><span class="sample" style="font-size:15px;font-weight:500">계약 현황을 확인해 보세요.</span><span class="mt">15 / 500</span></div><div class="row"><span class="nm">Caption</span><span class="sample" style="font-size:12px;font-weight:600;color:var(--muted)">캡션과 라벨</span><span class="mt">12 / 600</span></div></div>`
  },
  {
    slug: "spacing",
    name: "Spacing",
