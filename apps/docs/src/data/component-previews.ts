...
export const COMPONENT_PREVIEWS: Record<string, string> = {
  ...
  breadcrumb: `<div style="display:flex;align-items:center;gap:10px;font-size:13px;font-weight:700"><span style="color:#626F86">홈</span><span style="color:#98A2B3">/</span><span style="color:#626F86">계약</span><span style="color:#98A2B3">/</span><span style="color:#11152A">계약 상세</span></div>`,
  ...
  floatingmodal: `<div style="position:relative;width:78%;height:112px;background:#F2F4F6;border:1px solid #EEEFF2;border-radius:10px"><div style="position:absolute;right:10px;bottom:10px;width:58%;background:#fff;border-radius:10px;box-shadow:0 12px 28px rgba(17,21,42,.18);padding:10px"><div style="display:flex;justify-content:space-between;align-items:center;font-size:11px;font-weight:800;color:#11152A">파일 업로드<span style="color:#98A2B3">✕</span></div><i style="display:block;height:6px;border-radius:4px;background:#E4E7EC;margin-top:9px"></i><i style="display:block;height:6px;border-radius:4px;background:#EEF3FF;width:70%;margin-top:5px"></i></div></div>`,
  fullscreenmodal: `<div style="width:78%;height:112px;background:#fff;border:1px solid #EEEFF2;border-radius:10px;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 10px 24px rgba(17,21,42,.08)"><div style="display:flex;justify-content:space-between;align-items:center;padding:8px 12px;background:#F7F8FA;font-size:11px;font-weight:800;color:#11152A">계약서 편집<span style="color:#98A2B3">✕</span></div><div style="flex:1;padding:10px 12px;display:flex;flex-direction:column;gap:6px"><i style="display:block;height:6px;border-radius:4px;background:#E4E7EC;width:85%"></i><i style="display:block;height:6px;border-radius:4px;background:#E4E7EC;width:65%"></i></div><div style="display:flex;justify-content:flex-end;gap:6px;padding:8px 12px;border-top:1px solid #EEEFF2"><span style="font-size:10px;font-weight:700;padding:3px 10px;border-radius:6px;border:1px solid #E4E7EC;color:#626F86">취소</span><span style="font-size:10px;font-weight:700;padding:3px 10px;border-radius:6px;background:#2151EC;color:#fff">저장</span></div></div>`,
  ...
  textarea: `<div style="width:72%"><div style="background:#fff;border:1.5px solid #2151EC;border-radius:8px;padding:12px;display:flex;flex-direction:column;gap:7px;box-shadow:0 0 0 3px rgba(33,81,236,.12)"><i style="display:block;height:7px;border-radius:4px;background:#E4E7EC;width:90%"></i><i style="display:block;height:7px;border-radius:4px;background:#E4E7EC;width:70%"></i><i style="display:block;height:7px;border-radius:4px;background:#E4E7EC;width:45%"></i></div><div style="text-align:right;font-size:11px;font-weight:700;color:#98A2B3;margin-top:6px">45/200</div></div>`,
